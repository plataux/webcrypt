...
class JWE:
    ...
    __slots__ = ('_key', '_alg_name', '_enc_name', '_kty', '_kid',
    ...
    def __init__(self,
        ...
        self._jwe_header.alg = self._alg_name
    ...
    def _derive_key(self, px: JWE_Header, override_alg=True):
        ...
        if self._alg_name == 'ECDH-ES':
            ...
            jwe_alg = enc_map[self._alg_name]
